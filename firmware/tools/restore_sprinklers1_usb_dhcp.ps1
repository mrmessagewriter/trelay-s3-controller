...
<#
.SYNOPSIS
    Remove the Sprinklers1 Windows-side static USB network configuration.

.DESCRIPTION
    Removes the Sprinklers1 host route and firewall rule, then returns the
    MicroPython USB NCM adapter to DHCP for both IPv4 addressing and DNS.
#>
