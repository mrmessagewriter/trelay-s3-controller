...
Write-Host "=============================================="
Write-Host ""
Write-Host "MicroPython master derives a 169.254.x.1 controller address from the device MAC."
Write-Host "Use the 'USB IPv4:' value printed by Sprinklers1 as -ControllerIP."
Write-Host ""
